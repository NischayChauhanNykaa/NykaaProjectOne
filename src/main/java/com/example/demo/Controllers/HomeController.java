...
//		
		return "No Success "+target_user.getUserFirstName();
	}
	
	@RequestMapping("/testProductCategory")
	public String testProductCategory() {

		ProductCategory pc1 = new ProductCategory("Sample6");
		pc1.setCreated(new Date(0) );
	...
	public String testProduct() {
		...
		Product p1 = new Product("PN1","PC","PI","PT","PL","PI1","PI2","PI3","PI4","PI5");

		p1.setCreated(new Date(0) );
		p1.setDeleted(false);
		p1.setUpdated(new Date(0) );
		p1.setProductCategory(productCategoryRepository.findBycategoryId(1));
		productRepository.save(p1);
		
		 p1 = new Product("PN2","PC","PI","PT","PL","PI1","PI2","PI3","PI4","PI5");
			p1.setCreated(new Date(0) );
			p1.setDeleted(false);
			p1.setUpdated(new Date(0) );
		p1.setProductCategory(productCategoryRepository.findBycategoryId(1));
		productRepository.save(p1);
		 ...
		 p1 = new Product("PN3","PC","PI","PT","PL","PI1","PI2","PI3","PI4","PI5");
			p1.setCreated(new Date(0) );
			p1.setDeleted(false);
			p1.setUpdated(new Date(0) );
		p1.setProductCategory(productCategoryRepository.findBycategoryId(1));
		productRepository.save(p1);
		 ...
		 p1 = new Product("PN4","PC","PI","PT","PL","PI1","PI2","PI3","PI4","PI5");
			p1.setCreated(new Date(0) );
			p1.setDeleted(false);
			p1.setUpdated(new Date(0) );
		p1.setProductCategory(productCategoryRepository.findBycategoryId(1));
		productRepository.save(p1);
		 ...
		 p1 = new Product("PN5","PC","PI","PT","PL","PI1","PI2","PI3","PI4","PI5");
			p1.setCreated(new Date(0) );
			p1.setDeleted(false);
			p1.setUpdated(new Date(0) );
		p1.setProductCategory(productCategoryRepository.findBycategoryId(1));
